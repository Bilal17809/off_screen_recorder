...
//           child:  Text('Screen recording video',style: TextStyle(color: Colors.white,
...
//       if (directory != null) {
//         final videoDir = Directory('/storage/emulated/0/DCIM/ScreenRecording/');
...
//       selectedMedia = List<bool>.filled(savedMedia.length, false);
//       _loadAllThumbnailsAndVideoInfo(); // Reload thumbnails and video info after deletion
//     });
//   }
// }
  ...
  */
  ...
  Future<void> _loadSavedMedia() async {
    try {
      final directory = await getExternalStorageDirectory();
      if (directory != null) {
        final videoDir = Directory('${directory.path}/Movies/MyScreenVideos');
        final files = videoDir.listSync();
        savedMedia = files
            .where((entity) => entity is File && entity.path.endsWith('.mp4'))
            .toList();
